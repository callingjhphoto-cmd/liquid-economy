      ...
      {filters.map(filter => (
        <div key={filter.key} className="flex items-center gap-1.5">
          ...
          <select
            ...
            className="text-xs bg-gray-50 border border-gray-200 rounded-lg px-2 py-1.5 text-navy focus:outline-none focus:border-navy/30 focus:bg-white transition-colors cursor-pointer"
          >
