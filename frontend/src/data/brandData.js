...
export const BRAND_DATABASE = [
  ...
  { company: 'Diageo', brand: 'Johnnie Walker', expression: 'Black Label', category: 'Scotch Whisky', segment: 'Standard',
    prices: { uk: { tesco: 36, sainsburys: 30, waitrose: 34, masterofmalt: 29, thewhiskyexchange: 32.25 }, us: { totalwine: 35.99, bevmo: 37.99, costco: 33, reservebar: 42 }, spain: { elcorteingles: 29.99, carrefour_es: 28.90, lavinia_es: 32, bodeboca: 30, mercadona: 25.90 }, france: { carrefour_fr: 27, monoprix: 29, nicolas: 32, lavinia_fr: 30, auchan_fr: 26 }, germany: { edeka: 27, rewe: 28, kaufland: 26, weinquelle: 30, amazon_de: 28 }, italy: { esselunga: 28, tannico: 31, callmewine: 29, conad: 27, carrefour_it: 27 }, netherlands: { gall: 29, albert_heijn: 27, drankdozijn: 28, jumbo: 26, sligro: 25 }, me: { mmidubai: 42, africaneastern: 40, dutyfree_dxb: 35, lfrr: 45, centaurus: 41 } },
    offers: { uk: { tesco: { price: 24, label: 'Clubcard' }, sainsburys: { price: 22, label: 'Nectar' } } } },
