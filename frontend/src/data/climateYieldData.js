...
export const REGIONS = [
  ...
  },
  {
    ...
    avgYield: 1.8,
    priceLink: 'Agave prices have extreme cycles. 2020–21 shortage drove piña prices to \u002430/kg. Current oversupply pushing below \u00242/kg. 6–8 year lag between planting and harvest.',
    historical: {
      ...
      2017: { yield: 1.05, rainfall: 920, avgTemp: 22.4, frostDays: 1, sunHours: 2580, season: 'Shortage intensifying. Hurricane season brought needed rain but also flooding in lowlands. Young plants from emergency replanting still years from harvest. Price per kilo hit \u002422.', outlook: 'bearish' },
      ...
      2019: { yield: 1.35, rainfall: 870, avgTemp: 22.3, frostDays: 1, sunHours: 2640, season: 'Shortage peak. Piña prices hit all-time high of \u002430/kg. Massive replanting underway — over 40M new plants. Rain pattern favorable. Industry stress palpable.', outlook: 'bearish' },
      2020: { yield: 1.52, rainfall: 830, avgTemp: 22.6, frostDays: 0, sunHours: 2690, season: 'Early signs of relief. 2012–14 plantings coming online. COVID slowed on-premise demand but off-premise surged. Good growing conditions. Prices stabilizing around \u002420/kg.', outlook: 'neutral' },
      ...
      2022: { yield: 2.15, rainfall: 760, avgTemp: 23.1, frostDays: 0, sunHours: 2750, season: 'Oversupply emerging. Drought in some areas but vast planted area compensated. Piña prices crashed to \u00245/kg. Small farmers suffering.', outlook: 'bullish' },
      2023: { yield: 2.48, rainfall: 810, avgTemp: 22.7, frostDays: 0, sunHours: 2680, season: 'Full oversupply. Millions of tonnes of agave available. Price below \u00243/kg. Farmers pulling up plants. Some converting to corn. Tequila cost-of-goods falling.', outlook: 'bullish' },
      2024: { yield: 2.60, rainfall: 780, avgTemp: 23.0, frostDays: 0, sunHours: 2710, season: 'Glut continues. CRT struggling to manage production caps. Price at \u00242/kg. Significant farmer exits. New planting near zero — setting up NEXT shortage cycle (2030–32).', outlook: 'bullish' },
