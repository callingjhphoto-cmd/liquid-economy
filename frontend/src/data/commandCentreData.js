...
export const MARKET_PULSE = [
  ...
  { category: 'RTD / Ready-to-Drink', event: 'Spirits-based RTDs now 47% of US RTD volume; global RTD: +8.5%', impact: 'Sazerac closed BuzzBallz acquisition 2024 for ~$1B+; consolidation wave continues', change: '+8.5%', dir: 'up', date: 'Feb 22', detail: 'DISCUS reports US spirits-based RTDs growing +16.4% value and +20% volume in 2025, now representing 47% of RTD category volume (up from 8% in 2021). Sazerac Company completed its acquisition of BuzzBallz/Southern Champion in May 2024, the largest single-brand deal in Sazerac history, positioning Buffalo Trace\'s parent as a dominant RTD player. High Noon and Surfside leading US spirits-based hard seltzers; Cutwater and Diageo\'s expanded RTD portfolio intensifying shelf competition.', link: '/categories', linkLabel: 'View RTD Intelligence' },
