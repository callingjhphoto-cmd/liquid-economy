import { REGIONAL_PULSE_EXTENDED } from './regional_10yr_cagr_fragment'

export const DATA_LAST_UPDATED = '2026-04-14'
// Regional pulse now driven by 10-year extended dataset (2016-2025) with CAGR.
// Kept REGIONAL_PULSE as re-export for backwards compatibility with existing pages.
export { REGIONAL_PULSE_EXTENDED }
...
export const CATEGORY_SNAPSHOT = [
  { key: 'tequila', name: 'Tequila & Mezcal', size: '$4.8B', growth: '+7.8%', dir: 'up', signal: 'Agave surplus may ease costs', trend: [{ v: 3.2 }, { v: 3.6 }, { v: 4.0 }, { v: 4.4 }, { v: 4.8 }], channels: { onTrade: 38, offTrade: 42.1, eCommerce: 11.8, travelRetail: 8.1 } },
  { key: 'vodka', name: 'Vodka', size: '$40.1B', growth: '-0.8%', dir: 'down', signal: 'Premiumization offsetting volume decline', trend: [{ v: 41.5 }, { v: 41.2 }, { v: 40.8 }, { v: 40.4 }, { v: 40.1 }], channels: { onTrade: 34.7, offTrade: 51.9, eCommerce: 8.3, travelRetail: 5.1 } },
  { key: 'whisky', name: 'Whisky (Global)', size: '$6.3B', growth: '+4.2%', dir: 'up', signal: 'Japanese whisky supply constraints', trend: [{ v: 5.1 }, { v: 5.4 }, { v: 5.7 }, { v: 6.0 }, { v: 6.3 }], channels: { onTrade: 34.8, offTrade: 52.1, eCommerce: 4.2, travelRetail: 8.9 } },
  { key: 'gin', name: 'Gin', size: '$14.2B', growth: '+1.2%', dir: 'up', signal: 'Growth plateauing post-boom', trend: [{ v: 12.8 }, { v: 13.5 }, { v: 13.9 }, { v: 14.0 }, { v: 14.2 }], channels: { onTrade: 48.5, offTrade: 41.8, eCommerce: 6.8, travelRetail: 2.9 } },
  { key: 'rum', name: 'Rum', size: '$15.8B', growth: '+3.1%', dir: 'up', signal: 'Premium dark rum accelerating', trend: [{ v: 13.8 }, { v: 14.2 }, { v: 14.8 }, { v: 15.3 }, { v: 15.8 }], channels: { onTrade: 41.9, offTrade: 48.1, eCommerce: 4.9, travelRetail: 5.1 } },
  { key: 'cognac', name: 'Cognac & Brandy', size: '$4.1B', growth: '-2.4%', dir: 'down', signal: 'China tariff impact persists', trend: [{ v: 4.8 }, { v: 4.6 }, { v: 4.4 }, { v: 4.2 }, { v: 4.1 }], channels: { onTrade: 34.5, offTrade: 42.7, eCommerce: 11, travelRetail: 11.8 } },
  { key: 'champagne', name: 'Champagne & Sparkling', size: '$7.2B', growth: '+2.8%', dir: 'up', signal: 'Prosecco growth offsetting Champagne softness', trend: [{ v: 6.2 }, { v: 6.5 }, { v: 6.8 }, { v: 7.0 }, { v: 7.2 }], channels: { onTrade: 44.8, offTrade: 40, eCommerce: 5.1, travelRetail: 10.1 } },
...
export const MARKET_PULSE = [
  ...
  { category: 'RTD / Ready-to-Drink', event: 'Spirits-based RTDs now 47% of volume; +16.4% category growth', impact: 'Sazerac closed BuzzBallz acquisition 2024 for ~$1B+; consolidation wave continues', change: '+16.4%', dir: 'up', date: 'Feb 22', detail: 'DISCUS reports US spirits-based RTDs growing +16.4% value and +20% volume in 2025, now representing 47% of RTD category volume (up from 8% in 2021). Sazerac Company completed its acquisition of BuzzBallz/Southern Champion in May 2024, the largest single-brand deal in Sazerac history, positioning Buffalo Trace\'s parent as a dominant RTD player. High Noon and Surfside leading US spirits-based hard seltzers; Cutwater and Diageo\'s expanded RTD portfolio intensifying shelf competition.', link: '/categories', linkLabel: 'View RTD Intelligence' },
