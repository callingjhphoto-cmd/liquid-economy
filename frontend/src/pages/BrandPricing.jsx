...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Cell, ScatterChart, Scatter, Legend } from 'recharts'
import {
...
export default function BrandPricing() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <PageHeader
        title={<span className="inline-flex items-center">Brand Pricing Monitor<MethodologyTooltip text="38 core brands verified against retailer websites (April 2026). Extended portfolio of 325 brands uses index-estimated regional pricing derived from UK anchor prices and local market differentials." /></span>}
      ...
      <BentoGrid>
        <MetricCard
          ...
          icon={Package}
          sparkData={[{ v: 248 }, { v: 260 }, { v: 304 }, { v: 316 }, { v: 325 }]}
          direction="up"
          change="+25.0%"
        />
        <MetricCard
