...
const COMPANIES = [
  ...
  },
  {
    ...
    industryIntel: {
      ...
      brandIntel: [
        { name: "R\\u00e9my Martin", position: "Global cognac leader, VSOP to Louis XIII", trend: "up", latest: "Louis XIII launches Rare Cask program with allocated releases", marketShare: "21% of cognac market" },
      ...
      recentDevelopments: [
        ...
        { date: "2024-07", event: "R\\u00e9my Cointreau reports H1 organic growth +5.2%, led by Americas" },
