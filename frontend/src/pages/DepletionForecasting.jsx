...
const SEASONALITY_PROFILES = {
  ...
  winter: { label: 'Winter Spirits (Whisky, Cognac)', factors: [0.90, 0.80, 0.75, 0.70, 0.75, 0.80, 0.85, 0.85, 0.95, 1.20, 1.55, 1.90] },
      ...
      {liHasData && (
        <div className="border border-gold/30 rounded-xl bg-gradient-to-r from-amber-50/60 to-white p-4 mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs text-gray-400 ml-auto">Forecast Signals {'·'} {seasonality === 'champagne' ? 'Champagne' : profile.label}</span>
          </div>
