              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <ChartCard title={`Regional Distribution \u2014 ${selectedYear}`} height={240}>
                  <BarChart data={regionAnalysis} layout="vertical" accessibilityLayer={true}>
                    ...
                    <Tooltip formatter={(val) => [`${val} bars (${Math.round(val / 50 * 100)}%)`]} contentStyle={{ background: '#1e293b', border: 'none', borderRadius: 8, fontSize: 11 }} labelStyle={{ color: '#f1f5f9' }} itemStyle={{ color: '#94a3b8' }} />
            ...
            <div className="space-y-6">
              ...
              <ChartCard title={`Parent Company Penetration: % of Top 50 Bars (${selectedYear})`} subtitle="Click a company bar for their full profile" height={280}>
                <BarChart data={parentPenetration[selectedYear] || []} layout="vertical" accessibilityLayer={true}>
                  ...
                  <Tooltip formatter={(val) => [`${val}%`, 'Penetration']} contentStyle={{ background: '#1e293b', border: 'none', borderRadius: 8, fontSize: 11 }} labelStyle={{ color: '#f1f5f9' }} itemStyle={{ color: '#94a3b8' }} />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <ChartCard title="Top 5 Penetration Trend (%)" height={250}>
                  <LineChart data={penetrationTrend} accessibilityLayer={true}>
                    ...
                    <Tooltip formatter={(val) => [`${val}%`]} contentStyle={{ background: '#1e293b', border: 'none', borderRadius: 8, fontSize: 11 }} labelStyle={{ color: '#f1f5f9' }} itemStyle={{ color: '#94a3b8' }} />
                    <Legend />
