#!/usr/bin/env python3
"""Generate ClimateYield.jsx — Climate & Yield Intelligence page for Liquid Economy."""

JSX = r'''import React, { useState, useEffect, useMemo } from 'react'
...
with open('frontend/src/pages/ClimateYield.jsx', 'w') as f:
    f.write(JSX)

print(f"Generated ClimateYield.jsx: {len(JSX)} characters, {JSX.count(chr(10))} lines")
